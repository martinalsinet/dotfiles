...
Estoy probando [[https://termux.com/][Termux]], que permite usar emacs en Android. En el teclado bluetooth que estoy usando no me funciona la tecla Alt, así que necesito una alternativa para M-x. En [[https://sites.google.com/site/steveyegge2/effective-emacs][Effective Emacs]], Steve Yegge recomienda usar =C-x C-m=, y esa combinación es la que voy a usar.
...
** TODO Código fuente: check settings
