...
** Fuente FiraCode
   ...
   Me gusta usar la fuente [[https://github.com/tonsky/FiraCode][FiraCode]] porque tiene la funcionalidad /programming ligatures/, que hace que algunos de los símbolos más utilizados en programación se vean mejor. 

   En caso de usar emacs desde la consola no es necesario setear la fuente en la configuración, porque se hereda la fuente que tenga la consola.
